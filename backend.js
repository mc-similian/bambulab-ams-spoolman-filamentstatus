...
let SPOOLMAN_URL = `http://${SPOOLMAN_IP}:${SPOOLMAN_PORT}`;
...
const baseURL = `http://${SPOOLMAN_IP}:${SPOOLMAN_PORT}`;

SPOOLMAN_URL = SPOOLMAN_SUBFOLDER ? `${baseURL}${SPOOLMAN_SUBFOLDER}` : baseURL;
